...
public class LightsAllOutEndpoint {
	  ...
	  public LightsAllOut create(Principal principal, @RequestParam("status") String status, @RequestParam("streetAddress") String streetAddress, @RequestParam("xCoordinate") Integer xCoordinate,
