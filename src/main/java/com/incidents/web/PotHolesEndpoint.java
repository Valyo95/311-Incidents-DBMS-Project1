...
public class PotHolesEndpoint {
	  ...
	  public PotHoles create(Principal principal, @RequestParam("status") String status, @RequestParam("streetAddress") String streetAddress, @RequestParam("xCoordinate") Integer xCoordinate,
		  ...
		  MyUser user;
		    ...
		    return service.create(status, streetAddress, xCoordinate, yCoordinate, ward, policeDistrict, communityArea, latitude, longitude, location, currentActivity, mostRecentAction, potHoles, ssa);
