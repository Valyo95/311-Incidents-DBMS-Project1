...
public class AlleyLightsOutEndpoint {
	  ...
	  public AlleyLightsOut create(Principal principal, @RequestParam("status") String status, @RequestParam("streetAddress") String streetAddress, @RequestParam("xCoordinate") Integer xCoordinate,
