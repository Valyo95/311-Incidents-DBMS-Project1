...
public class ServiceException extends Exception {
	...
	public ServiceException(String message, Long errorCode, String errorDescription,
	...
	public ServiceException(String message, Long errorCode, String errorDescription,
			List<Object> messageParameters, Throwable cause) {
		super(message, cause);
		this.errorCode = errorCode;
		this.errorDescription = errorDescription;
		this.messageParameters = messageParameters;
	...
	public String toString() {
		return "SWServiceException [errorCode=" + errorCode + ", errorDescription=" + errorDescription
